...
interface OptionWheelProps {
  ...
  loop?: boolean
  draggable?: boolean
  /** Auto-advance to the next item every N ms when idle. 0/undefined disables it.
...
export default function OptionWheel({
  ...
  // Auto-advance when idle. Off entirely under prefers-reduced-motion, and
  // paused while the user is actively dragging the wheel.
  useEffect(() => {
  ...
  }, [autoAdvanceMs, isDragging, applyTarget])
  ...
  return (
    <div
      ...
      role="listbox"
      tabIndex={0}
      aria-label={ariaLabel ?? `Options: ${items.join(', ')}`}
